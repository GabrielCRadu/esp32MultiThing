...
Button brightnessButtons[] = {
  { 216, 242, 80, 70, tft.color565(186,186,186), "BRIGHT-"},
  { 304, 242, 80, 70, tft.color565(186,186,186), "BRIGHT+"}
};

uint8_t brightness = MAX_BRIGHTNESS;

ColorButton colorButtons[] = {
  { 216, 8,  80, 70, tft.color565(255,0,0), "RED", 255,0,0 },
  { 304, 8,  80, 70, tft.color565(255,128,0), "ORANGE", 255,128,0 },
  { 392, 8,  80, 70, tft.color565(255,217,0), "YELLOW", 255,217,0 },
  { 216, 86,  80, 70, tft.color565(0,170,255), "LIGHTBLUE", 0,170,255 },
  { 304, 86,  80, 70, tft.color565(0,255,183), "AQUA", 0,255,183 },
  { 392, 86,  80, 70, tft.color565(0,255,30), "GREEN", 0,255,0 },
  { 216, 164, 80, 70, tft.color565(38,0,255), "BLUE", 0,0,255 },
  { 304, 164, 80, 70, tft.color565(153,0,255), "VIOLET", 153,0,255 },
  { 392, 164, 80, 70, tft.color565(255,0,191), "PINK", 255,0,191 },
  { 392, 242, 80, 70, tft.color565(255,255,255), "WHITE", 255,255,255 }
};
...
void wledMenu(int touchX, int touchY) {
  ...
  if (touchX > brightnessButtons[1].x && touchX < brightnessButtons[1].x + brightnessButtons[1].w &&
      touchY > brightnessButtons[1].y && touchY < brightnessButtons[1].y + brightnessButtons[1].h) {
          if(brightness >= MAX_BRIGHTNESS-10)brightness = MAX_BRIGHTNESS;
          else brightness += 10;
